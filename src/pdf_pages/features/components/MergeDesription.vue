    ...
    <div class="try-sesction">
      <div class="block__container">
        ...
        <div class="md-layout">
          <div class="md-layout-item try-items">
            <div class="try-img">
              <img src="@/assets/img/icons/download-and-share.svg" alt="" />
            </div>
            <div>
              <div class="try-title">
          ...
          <div class="md-layout-item try-items">
            <div class="try-img">
              <img src="@/assets/img/icons/work-in-any-browser.svg" alt="" />
            </div>
            <div>
              <div class="try-title">
            ...
            <md-card>
              ...
              <md-card-header>
                ...
                <div class="md-subhead">
                  {{ $t("page_titles.merge_page.articleSection.description1") }}
                </div>
              </md-card-header>
            </md-card>
          </div>
          <div class="md-layout-item">
            <md-card>
              ...
              <md-card-header>
                ...
                <div class="md-subhead">
                  {{ $t("page_titles.merge_page.articleSection.description2") }}
                </div>
              </md-card-header>
            </md-card>
          </div>
          <div class="md-layout-item">
            <md-card>
              ...
              <md-card-header>
                ...
                <div class="md-subhead">
                  {{ $t("page_titles.merge_page.articleSection.description3") }}
                </div>
              </md-card-header>
            </md-card>
          </div>
